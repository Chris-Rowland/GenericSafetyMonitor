...
; Generated by Chris Rowland on 04/06/2019 (UTC)
;
[Setup]
AppID={{2472c7ad-f70e-428d-8eca-25b24b913f89}
AppName=ASCOM Generic Safety SafetyMonitor Driver
AppVerName=ASCOM Generic Safety SafetyMonitor Driver 6.4
AppVersion=6.4
...
OutputDir="."
OutputBaseFilename="Generic Safety Setup"
Compression=lzma
...
UninstallFilesDir="{cf}\ASCOM\Uninstall\SafetyMonitor\Generic Safety"

[Languages]
Name: "english"; MessagesFile: "compiler:Default.isl"

[Dirs]
Name: "{cf}\ASCOM\Uninstall\SafetyMonitor\Generic Safety"
; TODO: Add subfolders below {app} as needed (e.g. Name: "{app}\MyFolder")

[Files]
Source: "GenericSafety\bin\Debug\ASCOM.GenericSafety.SafetyMonitor.dll"; DestDir: "{app}"
; Require a read-me HTML to appear after installation, maybe driver's Help doc
Source: "GenericSafetyHelp.pdf"; DestDir: "{app}"; Flags: isreadme
; TODO: Add other files needed by your driver here (add subfolders above)

; Only if driver is .NET
[Run]
; Only for .NET assembly/in-proc drivers
Filename: "{dotnet4032}\regasm.exe"; Parameters: "/codebase ""{app}\ASCOM.GenericSafety.SafetyMonitor.dll"""; Flags: runhidden 32bit
Filename: "{dotnet4064}\regasm.exe"; Parameters: "/codebase ""{app}\ASCOM.GenericSafety.SafetyMonitor.dll"""; Flags: runhidden 64bit; Check: IsWin64

; Only if driver is .NET
[UninstallRun]
; Only for .NET assembly/in-proc drivers
Filename: "{dotnet4032}\regasm.exe"; Parameters: "-u ""{app}\ASCOM.GenericSafety.SafetyMonitor.dll"""; Flags: runhidden 32bit
; This helps to give a clean uninstall
Filename: "{dotnet4064}\regasm.exe"; Parameters: "/codebase ""{app}\ASCOM.GenericSafety.SafetyMonitor.dll"""; Flags: runhidden 64bit; Check: IsWin64
Filename: "{dotnet4064}\regasm.exe"; Parameters: "-u ""{app}\ASCOM.GenericSafety.SafetyMonitor.dll"""; Flags: runhidden 64bit; Check: IsWin64
